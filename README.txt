...
Basé sur la librairie js-hqx (https://github.com/phoboslab/js-hqx).
Programme créé par Eliastik (www.eliastiksofts.com)

VERSION DU PROGRAMME : 1.1.4 (date de version : 4/02/2017)
...
Ce programme vous permet d'agrandir des sprites de jeux vidéos directement sur votre navigateur internet, avec une meilleure qualité.
